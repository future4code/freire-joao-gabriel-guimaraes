 const iniciarJogo = () =>{
   ...
   let arrayComputador = [carta1computador.texto, carta2computador.texto]
       ...
       while (resultadoJogador < 21 && confirm(  "Suas cartas são " + arrayJogador + ". A carta revelada do computador é " + carta2computador.texto+"."+
         "\n"+
...
O computador ganhou!`)
 ...
 O usuário ganhou!`)
            ...
            else if (resultadoComputador > resultadoJogador && resultadoComputador <=21 || resultadoJogador > 21){
               alert(`Usuário - Cartas: ${arrayJogador} - Pontuação:  ${resultadoJogador}. 
 Computador - Cartas: ${arrayComputador} - Pontuação: ${resultadoComputador}. 
 O computador ganhou!`)
               }
